...
export default function JsonToSql() {
  ...
  return (
    <ToolLayout name="JSON → SQL" description="Gere statements SQL a partir de arrays JSON" badge="converter">
      ...
      <div style={{ display: 'flex', gap: 8 }}>
        <button className="btn primary" onClick={convert}>Gerar SQL <kbd style={{ marginLeft: 4, fontSize: 10, padding: '1px 3px', border: '1px solid currentColor', borderRadius: 2, opacity: 0.55, fontFamily: 'var(--font-mono)' }}>⌘↵</kbd></button>
        <OutputActions
          data={sqlOutput}
          filename="output.sql"
          mimeType="text/plain"
